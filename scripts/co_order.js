...
window.addEventListener("load", function() {
   ...
   var planOptions = document.querySelectorAll('input[name= "protection"]'); for (var i = 0; i <planOptions.length; i++) {
...
function calcOrder() {
   ...
   var pCost = document.querySelector('input[name="protect"]:checked').value*quantity;
